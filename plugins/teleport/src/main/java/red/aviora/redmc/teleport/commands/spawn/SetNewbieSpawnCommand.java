...
public class SetNewbieSpawnCommand implements Command<CommandSourceStack> {
    ...
    public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        plugin.getSpawnManager().setNewbieSpawn(player.getLocation());
        ApiUtils.sendPlayerMessageArgs(player,
            locale.getMessage(player, "spawn.set-newbie-success"),
