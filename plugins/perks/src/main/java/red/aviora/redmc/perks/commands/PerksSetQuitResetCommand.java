...
public class PerksSetQuitResetCommand implements Command<CommandSourceStack> {
	...
	public int run(CommandContext<CommandSourceStack> ctx) throws CommandSyntaxException {
		...
		plugin.getDataStorage().getPlayerData(player.getUniqueId()).setQuitMessage(null);

		ApiUtils.sendCommandSenderMessageArgs(player,
			plugin.getLocaleManager().getMessage(player, "perks.setquit.reset"),
