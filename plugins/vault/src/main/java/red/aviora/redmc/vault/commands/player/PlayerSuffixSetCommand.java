...
public class PlayerSuffixSetCommand implements Command<CommandSourceStack> {
	...
	public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
		...
		permissions.removeIf(p -> p.getName().startsWith("vault.suffix."));
		pData.addPermission(new PermissionEntry("vault.suffix." + suffix, weight, true));
