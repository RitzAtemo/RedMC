...
public class HologramMoveCommand implements Command<CommandSourceStack> {
	...
	public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
		...
		manager.moveHologram(data, player.getWorld().getName(), player.getX(), player.getEyeLocation().getY(), player.getZ());

		ApiUtils.sendCommandSenderMessageArgs(sender, locale.getMessage(sender, "hologram-moved"),
			"%prefix%", locale.getMessage(sender, "prefix"),
			"%id%", id);
