...
public class HologramDeleteCommand implements Command<CommandSourceStack> {
	...
	public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
		...
		manager.deleteHologram(id);

		ApiUtils.sendCommandSenderMessageArgs(sender, locale.getMessage(sender, "hologram-deleted"),
			"%prefix%", locale.getMessage(sender, "prefix"),
			"%id%", id);
