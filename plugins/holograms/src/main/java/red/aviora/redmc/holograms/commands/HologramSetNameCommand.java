...
public class HologramSetNameCommand implements Command<CommandSourceStack> {
	...
	public int run(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
		...
		ApiUtils.sendCommandSenderMessageArgs(sender, locale.getMessage(sender, "hologram-name-set"),
			"%prefix%", locale.getMessage(sender, "prefix"),
			"%id%", id,
			"%name%", name);
